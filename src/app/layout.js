...
export const metadata = {
  ...
  keywords: "HEIC to JPG, WebP to PNG, WebP to JPG, image converter, client side image converter, HEIC converter, local image conversion, fast image converter, online calculator, free web calculator, utility calculator, web calculator tool",
  robots: {
    index: true,
    follow: true,
    googleBot: {
